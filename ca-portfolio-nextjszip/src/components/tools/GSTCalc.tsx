...
export default function GSTCalc() {
  ...
  return (
    /* Structural container wrapper pushing content below the top panels and handling layout scrolling cleanly */
    <div
      style={{
        width: "100%",
        height: "100vh",
        maxHeight: "100vh",
        overflowY: "auto",
        paddingTop: "80px" /* Safe top zone padding */,
        paddingBottom: "40px",
        ...
        <div className="calc-split">
          <div className="calc-inputs">
            ...
            <div className="calc-info-box">
              ...
              >
                <strong style={{ color: "var(--accent)" }}>CGST + SGST</strong>{" "}
                — Intra-state transactions
                <br />
                <strong style={{ color: "var(--accent)" }}>IGST</strong> —
